...
class Node2Vec(BaseEmbedding):
    ...
    def node2vec(self, adj, embedding_dim=64, walk_length=30, walks_per_node=10,
        ...
        self.model = Word2Vec(walks, vector_size=embedding_dim, window=window_size, min_count=0, sg=1, workers=workers, negative=num_neg_samples, hs=0, compute_loss=True)
